...
# In this script, we genrate the data required to plot Figure 3(e)-(j).
...
#---------------------------
# Agent in subpopulation 1 are initially fully occpied site at 80<=i<=120, 
