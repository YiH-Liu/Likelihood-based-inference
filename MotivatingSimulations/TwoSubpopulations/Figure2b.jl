...
# In this script, we create Figure 2(b).
...
# Plot the snapshots for subpopulations 1 and 2 at the initial condition.
...
# Plot the snapshots for subpopulations 1 and 2 at time t.
